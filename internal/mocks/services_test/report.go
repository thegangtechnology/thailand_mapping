...
func (m *MockReport) Create(input models.CreateProductReportInput) (models.ProductReport, error) {
	m.ctrl.T.Helper()
...
func (mr *MockReportMockRecorder) Create(input interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Create", reflect.TypeOf((*MockReport)(nil).Create), input)
}
